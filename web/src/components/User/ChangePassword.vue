<template>
  <div id="change-password" class="section">
    <h1>修改密码</h1>
    <a-form :model="formState" name="changePassword" :label-col="{ span: 2 }" :wrapper-col="{ span: 8 }"
      autocomplete="off" @finish="changePassword" @finishFailed="onFinishFailed">
      ...
      <a-form-item label="重复新密码" name="confirmNewPassword"
        :rules="[{ required: true, message: '请重复输入新密码' }, { validator: validateConfirmPassword }]">
